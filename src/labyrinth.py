...
class Girl(Sprite):
    def __init__(self, pos, id, name, exit=(0,0)):
        ...
        self.imagen_normal = constants.images_labyrinth+'/'+name+'.png'
        self.imagen_check  = constants.images_labyrinth+'/'+name+'_check.png'            
...
class Ball(Sprite):
    def __init__(self, screen):
        Sprite.__init__(self)
        self.image = pygame.image.load(constants.images_labyrinth+\
                "/ball.png")
        self.rect = self.image.get_rect()
