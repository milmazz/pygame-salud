...
from riddle import Riddle1, Riddle2, Riddle3, Riddle4, Riddle5
...
def main():
    ...
    screen = pygame.display.set_mode(constants.screen_mode,
                                     constants.screen_flags, 32)

    pygame.display.set_caption('Salud')

    # TODO: Compile our own transparent cursor because this implementation is
    # slow.
